        ...
        <div className="w-full bg-white rounded-t-[28px] p-6 space-y-4" onClick={(e) => e.stopPropagation()}>
          ...
          <div className="flex flex-col gap-3">
            <div className="flex items-center justify-between">
              ...
              <button onClick={() => setSettingSecret(!settingSecret)} className={`relative w-12 h-6 rounded-full transition-colors ${settingSecret ? "bg-sky-100" : "bg-yellow-100"}`}>
                <span className={`absolute top-0.5 left-0.5 w-5 h-5 bg-white rounded-full transition-transform ${settingSecret ? "translate-x-[24px]" : "translate-x-0"}`}/>
              </button>
            </div>
            {settingSecret && (
              <input className="w-full h-11 rounded-xl bg-yellow-50  px-4 text-sm outline-none text-[gray-800] placeholder:text-[sky-400]"
            ...
            <div className="flex items-center justify-between">
              ...
              <button onClick={() => setSettingInviteOnly(!settingInviteOnly)} className={`relative w-12 h-6 rounded-full transition-colors ${settingInviteOnly ? "bg-purple-400" : "bg-yellow-100"}`}>
                <span className={`absolute top-0.5 left-0.5 w-5 h-5 bg-white rounded-full transition-transform ${settingInviteOnly ? "translate-x-[24px]" : "translate-x-0"}`}/>
              </button>
            </div>
            <div className="flex items-center gap-3">
              ...
              <input className="flex-1 h-11 rounded-xl bg-yellow-50  px-4 text-sm outline-none text-[gray-800] placeholder:text-[sky-400]"
          ...
          <button onClick={saveRoomSettings}
            className="w-full h-12 rounded-2xl bg-sky-100 text-sky-800 font-black active:scale-95 transition-transform">
            저장
          </button>
        </div>
      </div>
        ...
        <div className="flex items-center gap-2">
          {currentRoom?.createdBy === nickname && (
            <button
              ...
              className="w-9 h-9 flex items-center justify-center rounded-xl bg-gray-100 hover:bg-yellow-100 transition text-gray-500"
              title="방 설정"
            >
          ...
          <div className="flex flex-col gap-2">
            ...
            <div className="bg-white rounded-[14px]  px-3 py-2 flex flex-col gap-2">
              <div className="flex items-center justify-between">
                ...
                <button onClick={() => setNewIsSecret(!newIsSecret)} className={`relative w-10 h-5 rounded-full transition-colors ${newIsSecret ? "bg-sky-100" : "bg-yellow-100"}`}>
                  <span className={`absolute top-0.5 left-0.5 w-4 h-4 bg-white rounded-full transition-transform ${newIsSecret ? "translate-x-5" : "translate-x-0"}`}/>
                </button>
              </div>
              {newIsSecret && (
                <input className="w-full h-9 rounded-xl bg-yellow-50  px-3 text-xs outline-none text-[gray-800] placeholder:text-[sky-400]"
              ...
              <div className="flex items-center justify-between">
                ...
                <button onClick={() => setNewInviteOnly(!newInviteOnly)} className={`relative w-10 h-5 rounded-full transition-colors ${newInviteOnly ? "bg-purple-400" : "bg-yellow-100"}`}>
                  <span className={`absolute top-0.5 left-0.5 w-4 h-4 bg-white rounded-full transition-transform ${newInviteOnly ? "translate-x-5" : "translate-x-0"}`}/>
                </button>
              </div>
              <div className="flex items-center gap-2">
                ...
                <input className="flex-1 h-8 rounded-xl bg-yellow-50  px-3 text-xs outline-none text-[gray-800] placeholder:text-[sky-400]"
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-center gap-1.5">
                <span className="font-black text-sm truncate text-[gray-800]">{room.name}</span>
                {room.isSecret && (
