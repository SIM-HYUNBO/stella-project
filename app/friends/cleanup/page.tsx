    ...
    <main className="relative min-h-screen overflow-hidden">
      ...
      <div className="relative z-10">
        <div className="flex items-center h-14 px-4 bg-white border-b-2 border-gray-700 sticky top-0 z-20">
          ...
          <span className="font-black text-[gray-800] text-base">🧹 친구 정리</span>
        </div>
        <div className="px-5 pt-6 pb-16 space-y-3">
          {items.map(({ icon, label, sub }) => (
            <div key={label} className="rounded-[20px] bg-white border-2 border-gray-700 px-5 py-4 flex items-center gap-4 shadow-sm">
              <div className="w-12 h-12 rounded-xl bg-sky-500 flex items-center justify-center text-2xl shrink-0 shadow">{icon}</div>
              <div>
          ...
          <div className="rounded-[20px] bg-gray-50 border-2 border-gray-700 px-5 py-4 mt-2">
