      ...
      <div className="relative z-10">
        ...
        <div className="px-5 pt-6 pb-16 space-y-3">
          {items.map(({ icon, label, sub }) => (
            <div key={label} className="rounded-[20px] bg-white border border-gray-300 px-5 py-4 flex items-center gap-4 shadow-sm">
              <div className="w-12 h-12 rounded-xl bg-sky-100 flex items-center justify-center text-2xl shrink-0 shadow">{icon}</div>
              <div>
          ...
          <div className="rounded-[20px] bg-gray-50 border border-gray-300 px-5 py-4 mt-2">
