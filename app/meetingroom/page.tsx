  ...
  const renderRoom = () => (
    <div className="flex-1 flex flex-col overflow-hidden bg-gray-50">
      ...
      <button
        ...
        className="w-full flex items-center gap-2 px-4 py-2 bg-yellow-50 active:bg-sky-100 transition-colors shrink-0"
      >
      ...
      {showTopicEdit && (
        <div className="fixed inset-0 z-50 flex items-end justify-center bg-black/30 backdrop-blur-sm" onClick={() => setShowTopicEdit(false)}>
          <div className="w-full bg-white rounded-t-[28px] p-6 space-y-4" onClick={(e) => e.stopPropagation()}>
            ...
            <button
              onClick={saveTopic}
              className="w-full h-12 rounded-2xl bg-sky-100 text-white font-black text-base active:scale-95 transition-transform"
            >
              저장
            </button>
          </div>
