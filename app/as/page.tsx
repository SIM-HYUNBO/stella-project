    ...
    <main className="relative min-h-screen overflow-hidden">
      ...
      <div className="relative z-10">
        ...
        <div className="px-5 pt-6 pb-16 space-y-4">
          ...
          {/* 설명 카드 */}
          <div className="rounded-[24px] bg-white border border-gray-300 px-5 py-5 shadow-sm">
          ...
          {/* 토글 */}
          <div className="rounded-[24px] bg-white border border-gray-300 px-5 py-4 flex items-center justify-between shadow-sm">
            <div>
            ...
            <button onClick={toggle}
              className={`w-14 h-7 rounded-full transition-all duration-300 flex items-center px-0.5 ${enabled ? "bg-sky-100 shadow-md" : "bg-gray-200"}`}>
