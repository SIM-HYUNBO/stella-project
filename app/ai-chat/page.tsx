...
export default function AIChatPage() {
  ...
  return (
    <main className="relative h-screen overflow-hidden flex flex-col">
      ...
      {/* 헤더 */}
      <div className="relative z-10 flex items-center justify-between h-14 px-4 bg-white border-b border-gray-300 shrink-0">
        ...
        <div className={`px-3 py-1 rounded-full text-xs font-black shadow-sm ${isVip ? "bg-sky-100 text-sky-800" : "bg-sky-50 text-[sky-500]"}`}>
          {isVip ? "💎 VIP" : "FREE"}
        </div>
      </div>
      ...
      <div className="relative z-10 flex-1 overflow-y-auto px-4 py-4 space-y-3">
        {memory && isVip && (
          <div className="rounded-[16px] bg-sky-100 border border-amber-100 px-4 py-3 text-xs text-amber-700 font-semibold">
