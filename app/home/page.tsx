  ...
  return (
    <PageContainer>
      ...
      <div className="fixed top-5 right-20 z-50 flex items-center gap-3 mt-2">
        <Link href="/pro">
          <span className="px-6 py-3 bg-red-50 text-red-900 rounded-3xl border border-red-400">
            Pro 구입
          </span>
        </Link>
        ...
        {!user && (
          <Link href="/login">
            <span className="px-6 py-3 bg-yellow-50 text-orange-900 rounded-3xl border border-yellow-400">
              로그인
            </span>
          </Link>
        )}
