...
export default function FriendSettingsMenu() {
  ...
  const menus = [
    ...
    { icon: "🔕", label: "알림 끈 친구", sub: "알림을 끈 친구 목록",  path: "/friends/muted",    color: "from-amber-600" },
    ...
    <main className="relative min-h-screen overflow-hidden">
      ...
      <div className="relative z-10">
        <div className="flex items-center h-14 px-4 bg-white sticky top-0 z-20">
          ...
          <span className="font-black text-stone-800 text-base">친구 설정 ⚙️</span>
        </div>
            ...
            <button key={path} onClick={() => router.push(path)}
              ...
              <div className="bg-white px-5 py-4 flex items-center gap-4">
                ...
                <div className="text-left flex-1">
                  <p className="font-black text-stone-800 text-base">{label}</p>
